...
sys.stdout.write('\x1b]2; BMBF | BadarID Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
...
for brayen in range(10000):
    ...
    u3 = f"Mozilla/5.0 (Linux; Android 10; K) {str(rr(4,12))}.{str(rr(1,9))}.{str(rr(1,9))}like Mac OS X) AppleWebKit/537.36 (KHTML, like Gecko) CriOS/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Chrome/114.0.0.0 Mobile Safari/537.36"
